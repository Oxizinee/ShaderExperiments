...
in float ToonRampOffset, in float ToonRampOffsetPoint, in float Ambient, out float3 ToonRampOutput, out float3 Direction, out float ShadowAtan)
{
	...
	// set the shader graph node previews
		...
		// grab the main light
			...
			ShadowAtan = light.shadowAttenuation;
